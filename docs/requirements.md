...
Verification: unit test. Artifact: flight_sw/test/test_mode_manager.cpp. Status: in progress.
...
Verification: unit test. Artifact: flight_sw/test/test_fault_manager.cpp. Status: in progress.
...
Verification: unit test now, SIL scenario in the first SIL slice. Artifact: flight_sw/test/test_fault_manager.cpp. Status: planned.
